...
data_directory = 'E:\\Development Projects\\AI Data\\OpenCV_Resources\\colorpic6.jpg'
...
def join_image():
    ...
    imgStack = stack_images(0.9, ([img, imgGray], [imgGray, img]))
    horStack = np.hstack((img, img))
    verStack = np.vstack((img, img))
    # cv.imshow('Horizontal Stack', horStack)
